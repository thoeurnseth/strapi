...
export interface ApiCouponCoupon extends Schema.CollectionType {
  ...
  attributes: {
    code: Attribute.String;
    couponAmount: Attribute.String;
    description: Attribute.String;
    usageLimit: Attribute.String;
    expiryDate: Attribute.DateTime;
    couponType: Attribute.Enumeration<
      ['Percentage discount', 'Fixed cart discount']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiPlusgatePlusgate extends Schema.SingleType {
  collectionName: 'plusgates';
  info: {
    singularName: 'plusgate';
    pluralName: 'plusgates';
    displayName: 'Plusgate';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    privateKey: Attribute.Text & Attribute.Required;
    secretKey: Attribute.Text & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::plusgate.plusgate': ApiPlusgatePlusgate;
